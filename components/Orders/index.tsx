...
const Orders = () => {
  ...
  return <section id="catalogo" className="flex flex-col md:flex-row align-center mb-20 w-full md:items-stretch primary-gradient">
    ...
    <div className="md:w-1/2 p-10 flex justify-center items-center md:-skew-x-6 lg:-skew-x-12 lg:pl-32 lg:pr-32 md:max-w-screen-sm secondary-gradient">
      <form className="flex flex-row flex-wrap gap-2 md:skew-x-6 lg:skew-x-12 justify-center md:justify-end">
        ...
        <Input id="company" placeholder="Compañía"required />
        <Input type="tel" id="phone" placeholder="Teléfono" required />
        <Input type="email" id="email" placeholder="Email" required />
        <Input id="equipmentId" placeholder="ID del equipo" required />
        <textarea id="message" name="message" placeholder="Mensaje" rows={4} required className="py-2 px-4 w-full bg-white/70 placeholder:italic"></textarea>
        <button type="submit" className="bg-blue-800 text-amber-400 px-6 py-2 rounded-full text-xl font-medium mt-2  lg:hover:bg-blue-700">Enviar</button>
      </form>
    </div>
    <div className="hidden md:flex w-5 bg-amber-200/70 -skew-x-6 lg:-skew-x-12"></div>
    <div className="hidden md:flex w-5 bg-amber-200/40 -skew-x-6 lg:-skew-x-12"></div>
